...
class StoreStreetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'streetLightConditions_id' => 'required|numeric|not_in:0',
            'streetWeatherConditions_id' => 'required|numeric|not_in:0',
            'streetStrongWinds_id' => 'required|not_in:0',
            ...
            'informationSource_id' => 'required|not_in:0',
            'investigationMethod_id' => 'required|not_in:0',
            'informationSourceTrustLevel' => 'required|not_in:0',
            'investigationMethodTrustLevel_id' => 'required|numeric|not_in:0',
            '' => 'required|min:0',
            '' => 'required|min:0',
            '' => 'required|min:0',
            '' => 'required|min:0',
